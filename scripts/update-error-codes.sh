...
# Constants
readonly url=https://artifactory.es.atko.services/artifactory/okta-all/com/okta/monolith/core.exception-utils.api/%5BRELEASE%5D/core.exception-utils.api-%5BRELEASE%5D-metadata.jar
