...
<div>
  <nav class="top-bar-nav container">
          <a href="https://developer.okta.com/" class="top-bar-nav--logo">
          ...
          <nav :class="{'navigation':true, 'expanded': !topBarCollapsed}">
            <ul class="menu">
          ...
          <div class="top-bar-nav--controls">
           ...
           <div class="top-bar-nav--controls--toggle" @click="topBarCollapsed = !topBarCollapsed">
