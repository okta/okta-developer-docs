  ...
  <nav class="top-bar">
    ...
    <div class="top-bar--container">
      <div class="top-bar--header container">
        <a href="https://developer.okta.com/" class="top-bar--header--logo">
      ...
      <div class="top-bar--collapse container" :class="{'active': !topBarCollapsed}">
        <div class="top-bar--collapse--buttons">
          <a href="https://login.okta.com/" class="button is-button-cerise-outline">Login</a>
          <a href="https://developer.okta.com/signup/" class="button is-button-cerise">Sign Up</a>
