      ...
      <div class="hero-wrapper-container">
        ...
        >
          ...
          <p class="hero__paragraph dont-break-out">
            Identity for AI, apps, APIs, and infrastructure
          </p>
          <p class="hero__paragraph dont-break-out">
            Secure end-user flows, automate lifecycle management, and publish on
        ...
        >
          ...
          <template #description>
            The Integrator Free Plan org, designed for both developers and
            integrators, is now available! Existing Okta Developer Edition
            Service orgs will be deactivated starting on July 18, 2025. If
            you're an existing Okta Developer Edition user, you'll need to sign
...
export default {
  ...
  computed: {
    showBanner() {
      ...
      return (
        currentTimeEpoch >= bannerStartTimeEpoch &&
        currentTimeEpoch <= bannerEndTimeEpoch
      );
    },
  },
};
