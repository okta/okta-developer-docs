<template>
  <div>
      ...
      <div class="wrap">
        <header class="top-bar">
            ...
            <nav class="top-bar--primary-nav">
              <ul class="menu">
                <li v-for="(link, index) in $themeConfig.primary_nav" :key="index">
                  <router-link :to="link.link" v-html="link.text" :class="{'active': link.link.includes($page.path)}"></router-link>
                  <ul v-if="link.children && false===true" class="menu">
    ...
    <div class="page-body">
      <div class="content">
        <div class="content--container" style="height:50px">
          <span id="test">This area is for content</span>
        </div>
      </div>
      ...
      <div class="wrap">
        <footer>
          ...
          <div v-for="(column, index) in $themeConfig.footer_nav" :key="index" class="footer--links">
