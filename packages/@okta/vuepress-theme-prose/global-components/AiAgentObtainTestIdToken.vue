<template>
  <div v-pre>
    ...
    <blockquote>
      <p>
        <strong>Note:</strong> Add the helper's callback URL (for example, <code>http://localhost:5000/callback</code>) to the linked OIDC app's <strong>Sign-in redirect URIs</strong> before you run it, and remove it after verification is complete.
      </p>
    </blockquote>
  </div>
</template>
