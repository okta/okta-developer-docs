  ...
  <div id="cors-test">
    ...
    >
      ...
      <button 
        ...
        @click="testCors"
      >
        <i class="fa fa-cloud-download"></i> Test
      </button>
    </form>
    <div 
      class="cors-test-result" 
      v-if="info"
    >
        ...
        <div class="panel-body">
          ...
          >
            <div class="form-group">
              <label class="col-1-3 control-label">
                ID
              </label>
              <div class="col-2-3">
