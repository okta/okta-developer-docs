...
<span class="token punctuation">{</span>
    ...
    <span class="token property">"errorLink"</span><span class="token punctuation">:</span> <span class="token string">"https://developer.okta.com/docs/references/error-codes/#{{oktaError.errorCode}}"</span><span class="token punctuation">,</span>
