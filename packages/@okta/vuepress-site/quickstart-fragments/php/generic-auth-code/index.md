...
This access token is a JWT and should be verified according to the process described in [Validate access tokens](/docs/guides/validate-access-tokens).  This verification can be done easily with the [Okta JWT Verifier for PHP](https://github.com/okta/okta-jwt-verifier-php/).
