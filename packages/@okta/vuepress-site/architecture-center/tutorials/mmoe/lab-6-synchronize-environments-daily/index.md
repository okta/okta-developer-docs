...
4. In the **Send Message to Channel** card, configure the output channel used for notifications when drift is detected.
   1. Click **Choose Connection**, select the channel you set up in [a Slack channel](/architecture-center/tutorials/mmoe/lab-prerequisites/#a-slack-channel), and select your desired input and output fields.
