...
1. Open the the `saml-autoconfig.php` file for SimpleSAMLphp in your favorite text editor.
    ...
    Be sure to replace the contents of `${metadataUrl}` with the link that you copied in step \#10 that you followed earlier.
