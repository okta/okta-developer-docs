...
> **Note:** If event hook requests are identified as failing (timing out) consistently, Okta skips the deliveries for that hook for 15 minutes to improve system performance.
