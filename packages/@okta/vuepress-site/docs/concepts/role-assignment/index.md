...
| `okta.workflows.read` <br><ApiLifecycle access="ea" />      | Allows the admin to view delegated flows                                                                                                    | All Delegated Flows, a specific Delegated Flow |
...
| `okta.devices.lifecycle.deactivate` <br><ApiLifecycle access="ea" />                          | Allows the admin to deactivate devices. When a device is deactivated, it loses all device user links.                                                                                                        | All Devices
