...
> **Note:** This functionality is available as an Early Access (EA) feature for Identity Engine orgs. Enable the **Authenticator enrollment sets** self-service feature. You can't enable it in an org that uses the [Flexible Okta Verify authenticator configuration](/docs/guides/authenticators-okta-verify/main/#configure-okta-verify-as-standalone-authenticators) feature.
