...
The following table details the configurations that define which Authentication API (either Okta Classic Engine or Identity Engine) that your application is using based on your deployment model.
