...
For information on updating the configuration of the Okta Auth JavaScript SDK, see [Okta Auth JavaScript SDK - Configuration reference](https://github.com/okta/okta-auth-js/blob/master/README.md#configuration-reference).
...
For information on updating the configuration of the Okta React SDK, see [Okta React SDK - Configuration options](https://github.com/okta/okta-oidc-js/tree/master/packages/okta-react#configuration-options).
...
For information on updating the configuration of the Okta Angular SDK, see [Okta Angular SDK - Usage](https://github.com/okta/okta-oidc-js/tree/master/packages/okta-angular#usage).
