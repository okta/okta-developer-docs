...
* [Sumo Logic integration with Okta](https://www.okta.com/integrations/sumo-logic/)
...
See [System Log filters and search](https://help.okta.com/okta_help.htm?type=oie&id=csh-syslog-filters) and [System Log query](/docs/reference/system-log-query/) for common system log query use cases.
