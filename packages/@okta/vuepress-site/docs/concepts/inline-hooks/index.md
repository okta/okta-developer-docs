...
| Telephony inline hook | The Okta process to deliver the OTP continues and the OTP is sent using the Okta providers. The failover system that uses the Okta telephony providers is heavily rate-limited. |
