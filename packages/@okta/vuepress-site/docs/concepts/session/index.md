...
See the [Sign users out](/docs/guides/oie-embedded-sdk-use-case-basic-sign-out/android/main/) guide (located within the **Sign users in** section of developer.okta.com) for a guide to implement Okta sign out in Okta Classic Engine. For Admin Console app-initiated SLO configuration, see [Configure Single Logout in app integrations](https://help.okta.com/okta_help.htm?id=ext_Apps_Single_Logout).
