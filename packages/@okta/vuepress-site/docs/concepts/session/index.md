...
Not all apps integrated with Okta support single logout. See [Single Logout in applications](https://help.okta.com/en/prod/Content/Topics/Apps/Apps_Single_Logout.htm) to trigger single logout in apps that support the feature.
