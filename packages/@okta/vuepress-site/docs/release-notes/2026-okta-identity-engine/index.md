...
| ------ | ------------------------ |
| [Improved validation for Create a client authentication endpoint](#improved-validation-for-create-a-client-authentication-endpoint) | June 24, 2026 |

#### Improved validation for Create a client authentication endpoint

Validation for the [Create a client authentication endpoint](https://developer.okta.com/docs/api/secures-ai/openapi/secures-ai-resource-servers/tags/resourceserverclientauthsettings/other/createclientauthsettings) now restricts the `purpose` parameter to a single value. <!-- OKTA-120008 -->
