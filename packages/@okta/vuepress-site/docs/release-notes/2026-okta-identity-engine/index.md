...
* The new [Manage the identifier-first sign-in transition](/docs/guides/oie-manage-id-first-signin/main/) guide and [Okta Identity Engine: Identifier-First Sign-in Experience](/docs/concepts/oie-idfirst-signin/) concept doc explain how the move from Classic Engine to Identity Engine changes sign-in flows from a combined form to a two-page identifier-first flow. The concept doc details how this pattern asks users for their identifier first, then dynamically determines the appropriate authentication method. The guide covers testing strategies and security considerations for planning your transition before going live. <!-- OKTA-1216265 -->
