...
See [Update the org request settings](https://developer.okta.com/docs/api/iga/openapi/governance-production-requests-admin-v2-reference/request-settings/updateorgrequestsettingsv2) to configure this setting through the API.
...
The following endpoints weren't visible in the Rate limit report:
  ...
  * `/governance/api/v1/my/campaigns/{campaignId}/reviews/bulk-decisions/jobs/{jobId}` (OKTA-1211609)
...
| [Developer documentation update in 2026.04.0](#developer-documentation-update-in-2026-04-0) |  |
