...
|--------|--------------------------|-----------------------------|
| [Enhanced Filtering for Security Policies API is GA in preview](#enhanced-filtering-for-security-policies-api-is-ga-in-preview)| December 10, 2025 | December 10, 2025 |
