...
* When users were created using the API (`/users/${userId}/factors/questions`), a null custom security question and answer were included in the response. (OKTA-567970)
