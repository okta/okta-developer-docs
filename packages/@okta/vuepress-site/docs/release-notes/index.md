...
> **Note:** Changes to Okta unrelated to API Products are published in the [Okta Release Notes](https://help.okta.com/en/prod/okta_help_CSH.htm#ext_okta_relnotes) for admins. See [Okta Identity Engine Releae Notes](https://help.okta.com/oie/en-us/Content/Topics/ReleaseNotes/oie-relnotes.htm) for changes to Okta Identity Engine that are unrelated to Okta Identity Engine API Products.
