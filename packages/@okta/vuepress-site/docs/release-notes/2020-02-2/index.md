...
* When the Security Question option wasn't enabled in the password policy, requests to the Forgot Password endpoint would return a 403 error when the `sendEmail` query parameter was set to `false`. (OKTA-272392)
