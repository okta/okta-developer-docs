...
* When a request was made to the `/authorize/` endpoint, a user was still prompted to sign in when the `prompt` property was set to `none` and the user had a valid session token. (OKTA-514346)
