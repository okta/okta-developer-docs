...
Users who attempt to enroll in Okta Verify using SMS can now be rate limited. Additionally, Okta Verify enrollment rate-limit events are now logged in the System Log.<!-- OKTA-502632 -->
