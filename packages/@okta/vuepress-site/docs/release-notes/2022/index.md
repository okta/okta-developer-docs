...
|--------------------------------------------------------------------------|--------------------------|
| [Password history policy enforced in strict mode is GA in Preview](#bug-fixed-in-2022-12-0)                       | December 7, 2022         |
| [PBKDF2 Hashing Algorithm support is GA in Preview](#bug-fixed-in-2022-12-0)                       | December 7, 2022         |
| [Preview the token inline hook](#bug-fixed-in-2022-12-0)                       | December 7, 2022         |
| [Revoke user sessions is GA in Preview](#bug-fixed-in-2022-12-0)                       | December 7, 2022         |
| [Step-up authentication using ACR values is GA in Prod](#bug-fixed-in-2022-12-0)                       | December 7, 2022         |
| [Redirect added to end of sign-in flow](#bug-fixed-in-2022-12-0)                       | December 7, 2022         |
| [Loading Page Animation feature for the Brands API is GA in Production](#bug-fixed-in-2022-12-0)                       | December 7, 2022         |
| [Rate limit parameter matching](#bug-fixed-in-2022-12-0)                       | December 7, 2022         |
| [Bugs fixed in 2022.12.0](#bug-fixed-in-2022-12-0)                       | December 7, 2022         |
