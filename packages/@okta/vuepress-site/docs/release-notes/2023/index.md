...
* When an admin configured a custom email domain using the [Email Domain API](https://developer.okta.com/docs/api/openapi/okta-management/management/tag/EmailDomain/), they couldn't change the autogenerated CNAME record. (OKTA-645037)
