...
When the [ThreatInsight](/docs/reference/api/threat-insight/#threatinsight-configuration-api-operations) endpoint was called, the response included non-ISO standard date and timestamp formats for the `created` and `lastUpdated` keys. (OKTA-445365)
