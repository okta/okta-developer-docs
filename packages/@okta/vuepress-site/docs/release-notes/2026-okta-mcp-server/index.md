...
|--------|--------------------------|
| [Customization tools for Okta MCP server is GA in Production](#customization-tools-for-okta-mcp-server-is-ga-in-production)| June 3, 2026 |
| [Scope-based tool loading for Okta MCP server is GA in Production](#scope-based-tool-loading-for-okta-mcp-server-is-ga-in-production)| June 3, 2026 |
| [Device Assurance Policy tools for Okta MCP server is GA in Production](#device-assurance-policy-tools-for-okta-mcp-server-is-ga-in-production)| June 3, 2026 |
