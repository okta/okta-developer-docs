...
Consider how your users sign in when they access your portal before designing your sign-in form. Your Okta org includes three [preset authentication policies](https://help.okta.com/okta_help.htm?type=oie&id=ext-preset-auth-policies): password only, any one factor, and any two factors. Also, your org comes with four basic authentication factors enabled: password, email, SMS, and voice.

When you need to [add an authentication factor](https://help.okta.com/okta_help.htm?type=oie&id=ext-about-authenticators) or build a custom one, you can do it all in the Admin Console, no coding necessary.
