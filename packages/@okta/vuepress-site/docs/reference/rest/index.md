...
You need a free Okta Developer Edition org to get started. Don't have one? [Create an org for free](https://developer.okta.com/signup). The Okta Developer Edition org is assigned a base URL such as `trial-1234567.okta.com`. This is your unique subdomain in Okta.
