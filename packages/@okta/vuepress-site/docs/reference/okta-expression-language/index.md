...
> **Note:** The `user.getGroups` function was previously only available for certain features on Okta Identity Engine, but has since been expanded to be used for all features that can use Expression Language.
