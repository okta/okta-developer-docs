...
| `toLowerCase(string)`             | `toLowerCase(source.firstName)`     | AlexANDER     | oleander |
...
For these samples, assume that the *user* has the attributes in Okta.
...
| First name + Lastname                                               | `user.firstName + user.lastName`                                                                                                                         | WinstonChurchill        | Obtain the Firstname and Lastname values and append each together.                                                                                                                                                                                                                                                                                                                                         |
