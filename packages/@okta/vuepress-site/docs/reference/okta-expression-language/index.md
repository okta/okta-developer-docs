...
> **Note:** The `user.getGroups` function was previously only available for certain features on Okta Identity Engine,but has since been expanded to all features that allow Expression Language.
