...
| inlineHooks                                                              | Associates the application with SAML inline hooks. See the [SAML assertion inline hook reference](/docs/reference/saml-hook/).                                                    | String                                                         | TRUE     | FALSE  |                                           |
...
| samlAssertionLifetimeSeconds <ApiLifecycle access="ea" />                | Determines the SAML Application session lifetimes with Okta                                                                                                                                   | Integer                                                        | TRUE     | FALSE  |                                           |
