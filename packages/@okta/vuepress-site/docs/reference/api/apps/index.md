...
| sector_identifier_uri  <ApiLifecycle access="ea" />                           | When `subject_type` is `pairwise`, this URL references a file with a single JSON array of `redirect_uri` values used to calculate Pseudonymous Identifiers.                                                                                                       | URL                                                                                                                                                                                                                                                               | TRUE       | FALSE    | TRUE      |
| subject_type  <ApiLifecycle access="ea" />                                    | Array of OAuth 2.0 subject type strings. Default value: `public`                                                                                                                                                                                                  | Array of `public`, `pairwise`                                                                                                                                                                                                                                     | TRUE       | FALSE    | TRUE      |
