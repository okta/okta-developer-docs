...
| grant_types                                                                                               | Array of OAuth 2.0 grant type strings                                                                                                                                                                                      | Array of `authorization_code`, `implicit`, `password`, `refresh_token`, `client_credentials`, `urn:ietf:params:oauth:grant-type:saml2-bearer`, `urn:openid:params:grant-type:ciba` <ApiLifecycle access="ie" /> <ApiLifecycle access="ea" />, `urn:okta:params:oauth:grant-type:otp` <ApiLifecycle access="ie" /> <ApiLifecycle access="ea" />, `urn:okta:params:oauth:grant-type:oob` <ApiLifecycle access="ie" /> <ApiLifecycle access="ea" />, `http://auth0.com/oauth/grant-type/mfa-otp` <ApiLifecycle access="ie" /> <ApiLifecycle access="ea" />, `http://auth0.com/oauth/grant-type/mfa-oob` <ApiLifecycle access="ie" /> <ApiLifecycle access="ea" />    | FALSE      | FALSE    | TRUE       |
