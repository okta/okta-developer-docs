...
| logo_uri                                    | URL string that references a logo for the client.<br><br> This value is used with the client consent dialog box during the client consent flow when you:<ul><li> Create an app using the API and specify a value for `logo_uri`</li><li>Create an app in the UI and specify a value for **Application logo**.</li></ul>This value is used as the logo on the application's tile for the dashboard when you:<ul><li>Create an app in the UI and specify a value for **Application logo**.</li></ul>               | URL                                                                                            | TRUE       | FALSE    | FALSE      |
