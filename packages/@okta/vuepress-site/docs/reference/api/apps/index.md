...
| grant_types                                                                                            | Array of OAuth 2.0 grant type strings                                                                                                                                                                                      | Array of `authorization_code`, `implicit`, `password`, `refresh_token`, `client_credentials`, `urn:ietf:params:oauth:grant-type:saml2-bearer`, `urn:openid:params:grant-type:ciba` <ApiLifecycle access="ie" />   | FALSE      | FALSE    | TRUE       |
