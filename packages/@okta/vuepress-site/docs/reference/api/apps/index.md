...
Generates a new key pair and returns the CSR (Certificate Signing Request) for it. The information in a CSR is used to verify and create your SSL certificate. It also contains the public key that will be included in your certificate.
