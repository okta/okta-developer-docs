...
| PROFILE_MASTERING      | Allow ${app} to source Okta users               | Designates the app as the identity lifecycle and profile attribute authority for linked users. The user's profile in Okta is *read-only*                                                                                                     |
