...
| grant_types                                 | Array of OAuth 2.0 grant type strings                                                                                                                                                                                      | Array of `authorization_code`, `client_credentials`, `implicit`, `interaction_code`, `password`, `refresh_token` | FALSE      | FALSE    | TRUE       |
