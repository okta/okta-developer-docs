...
The Apps API reference is now available at the new [Okta API reference portal](https://developer.okta.com/docs/api/openapi/okta-management/management/tag/Application/).
...
> **Note:** You can't send this request to Okta Integrator Free Plan orgs because the Org2Org app integration isn't available. If you need to test this feature in your Integrator Free Plan org contact your Okta account team.
...
The request payload to create a SAML 2.0 authentication OIN app instance is available in the [Applications Schema](https://developer.okta.com/docs/api/openapi/okta-management/management/tag/Application/) section of the new [Okta API reference portal](https://developer.okta.com/docs/api/).
...
* The `name` field is required, which identifies the OIN app definition for the instance that you want to create. See [App name](#app-names).
* Specify `SAML_2_0` in the required `signOnMode` parameter.
...
* Specify `AUTO_LOGIN` in the required `signOnMode` parameter.
* Specify a required `label` for your custom app.
* Specify required parameters in [`settings`](#settings-8).
* Don't specify the `name` parameter. This property is autogenerated after the app instance is created. If you specify `name` for a custom SWA app instance, the POST request returns an error.
...
* Specify `SAML_2_0` in the required `signOnMode` parameter.
* Specify a required `label` for your custom app.
* Specify required SAML 2.0 parameters in [`settings`](#settings-9).
* Don't specify the `name` parameter. This property is autogenerated after the app instance is created. If you specify `name` for a custom SAML 2.0 app instance, the POST request returns an error.
...
| assertionSigned                                                          | Determines whether the SAML assertion is digitally signed                                                                                                                         | Boolean                                                        | FALSE    | FALSE  |                                           |
...
| defaultRelayState                                                        | Identifies a specific app resource in an IdP-initiated SSO scenario                                                                                                                   | String                                                         | TRUE     | FALSE  |                                           |
| destination                                                              | Identifies the location inside the SAML assertion where the SAML response should be sent                                                                                           | String                                                         | FALSE    | FALSE  | [URL](http://tools.ietf.org/html/rfc3986) |
...
| inlineHooks                                                              | Associates the app with SAML inline hooks. See the [SAML assertion inline hook reference](https://developer.okta.com/docs/api/openapi/okta-management/management/tag/InlineHook/#tag/InlineHook/operation/createSAMLAssertionInlineHook).                                                    | String                                                         | TRUE     | FALSE  |                                           |
...
| requestCompressed                                                        | Determines whether the SAML request is expected to be compressed                                                                                                                      | Boolean                                                        | FALSE    | FALSE  |                                           |
| responseSigned                                                           | Determines whether the SAML authentication response message is digitally signed by the IdP                                                                                            | Boolean                                                        | FALSE    | FALSE  |                                           |
| samlAssertionLifetimeSeconds <ApiLifecycle access="ea" />                | Determines the SAML app session lifetimes with Okta                                                                                                                                   | Integer                                                        | TRUE     | FALSE  |                                           |
...
| slo                                                                      | Determines if the app supports Single Logout                                                                                                                                          | [Single Logout](#single-logout-object)                         | TRUE     | FALSE  |
| participateSlo <ApiLifecycle access="ie" /> <ApiLifecycle access="ea" /> | Determines if the app participates in Single Logout                                                                                                                                   | [Participate Single Logout](#participate-single-logout-object) | TRUE     | FALSE  |
...
See [Create an OAuth 2.0 client Application](https://developer.okta.com/docs/api/openapi/okta-management/management/tag/Application/#tag/Application/operation/createApplication!path=4/signOnMode&t=request) in the new [Okta API reference portal](https://developer.okta.com/docs/api/).
...
| grant_types                                                                                               | Array of OAuth 2.0 grant type strings                                                                                                                                                                                      | Array of `authorization_code`, `implicit`, `password`, `refresh_token`, `client_credentials`, `urn:ietf:params:oauth:grant-type:saml2-bearer`, `urn:openid:params:grant-type:ciba` <ApiLifecycle access="ie" /> <ApiLifecycle access="ea" />   | FALSE      | FALSE    | TRUE       |
...
If you have [configured a custom domain](/docs/guides/custom-url-domain/), the issuer is returned in the appropriate OpenID Connect token response. When a custom URL domain is configured, the default value for new apps is `CUSTOM_URL`. <br>
...
> **Note:** When you [merge duplicate app sign-in policies](https://help.okta.com/okta_help.htm?type=oie&id=ext-merge-auth-policies), policy and mapping CRUD operations may be unavailable during the consolidation. When the consolidation is complete, you receive an email.
...
The Application client secret management operations reference is now available at the new [Okta API reference portal](https://developer.okta.com/docs/api/) as the [Application Client Auth Credentials API](https://developer.okta.com/docs/api/openapi/okta-management/management/tag/ApplicationSSOCredentialOAuth2ClientAuth/).
...
The Application client JSON Web Key management operations reference is now available at the new [Okta API reference portal](https://developer.okta.com/docs/api/) as the [Application Client Auth Credentials API](https://developer.okta.com/docs/api/openapi/okta-management/management/tag/ApplicationSSOCredentialOAuth2ClientAuth/).
...
See [Application object in the response](https://developer.okta.com/docs/api/openapi/okta-management/management/tag/Application/#tag/Application/operation/getApplication!c=200&path=0/signOnMode&t=response) in the new [Okta API reference portal](https://developer.okta.com/docs/api/).
...
| name               | The unique key for app definition. This field is required for all apps except for a custom SAML 2.0 or SWA app.  | String ([App Names](#app-names))                | FALSE        | TRUE       | TRUE         | 1             | 255         |
