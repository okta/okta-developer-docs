...
| `okta.users.credentials.resetFactors`   | Allows the admin to reset users' MFA authenticators.                                                                                                  | All Users, all Users within a specific Group |
| `okta.users.credentials.resetPassword`  | Allows the admin to reset users' passwords.                                                                                                           | All Users, all Users within a specific Group |
...
| `okta.users.lifecycle.suspend`          | Allows the admin to suspend users' access to Okta. When a user is suspended, their user sessions are also cleared.                                    | All Users, all Users within a specific Group |
| `okta.users.lifecycle.unsuspend`        | Allows the admin to restore users' access to Okta.                                                                                                    | All Users, all Users within a specific Group |
...
| `okta.users.lifecycle.clearSessions`    | Allows the admin to clear all active Okta sessions and OAuth tokens for an end user.                                                                  | All Users, all Users within a specific Group |
