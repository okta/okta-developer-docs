...
| `okta.users.credentials.resetFactors`   | Gives your delegated admin the ability to reset users' MFA authenticators.                                                                            | All Users, all Users within a specific Group |
| `okta.users.credentials.resetPassword`  | Gives your delegated admin the ability to reset users' passwords.                                                                                     | All Users, all Users within a specific Group |
| `okta.users.credentials.expirePassword` | Gives your delegated admin the ability to expire a user’s password and set a new temporary password.                                                  | All Users, all Users within a specific Group |
...
| `okta.users.lifecycle.activate`         | Gives your delegated admin the ability to activate user accounts.                                                                                     | All Users, all Users within a specific Group |
| `okta.users.lifecycle.deactivate`       | Gives your delegated admin the ability to deactivate user accounts.                                                                                   | All Users, all Users within a specific Group |
| `okta.users.lifecycle.suspend`          | Gives your delegated admin the ability to suspend users' access to Okta. When a user is suspended, their user sessions are also cleared.              | All Users, all Users within a specific Group |
| `okta.users.lifecycle.unsuspend`        | Gives your delegated admin the ability to restore users' access to Okta.                                                                              | All Users, all Users within a specific Group |
| `okta.users.lifecycle.delete`           | Gives your delegated admin the ability to permanently delete user accounts.                                                                           | All Users, all Users within a specific Group |
| `okta.users.lifecycle.unlock`           |	Gives your delegated admin the ability to unlock users who have been locked out of Okta.                                                              | All Users, all Users within a specific Group |
| `okta.users.lifecycle.clearSessions`    | Gives your delegated admin the ability to clear all active Okta sessions and OAuth tokens for an end user.                                            | All Users, all Users within a specific Group |
...
| `okta.profilesource.import.run`         | Gives your delegated admin the ability to run imports for apps with a profile source, such as HRaaS and AD/LDAP apps. Admins with this permission can create users through the import. | All Profile Source Apps, All profile source apps of specific type, a specific Profile Source App |
#### Example
