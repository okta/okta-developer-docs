...
|                         | A specific App                                                      | `orn:${partition}:idp:${yourOrgId}:apps:${appType}:${yourAppClientId}`                          | [`https://${yourOktaDomain}/api/v1/apps/${yourAppClientId}`](/docs/reference/api/apps/#get-application)                                                           |
...
|                         | A specific Authorization Server   <br><ApiLifecycle access="ea" />  | `orn:${partition}:idp:${yourOrgId}:authorization_servers:${yourAuthorizationServerId}`    | [`https://${yourOktaDomain}/api/v1/authorizationServers/${yourAuthorizationServerId}`](/docs/reference/api/authorization-servers/#get-authorization-server) |
