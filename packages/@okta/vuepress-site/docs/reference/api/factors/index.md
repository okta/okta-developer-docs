...
> **Notes:** The current [rate limit](/docs/reference/rate-limits/) is one SMS challenge per device every 30 seconds.<br><br> Okta round-robins between SMS providers with every resend request to help ensure delivery of SMS OTP across different carriers.
...
> **Note:** The current [rate limit](/docs/reference/rate-limits/) is one voice call challenge per device every 30 seconds.
