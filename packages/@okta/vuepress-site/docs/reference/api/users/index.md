...
| salt       | String   | For Salted SHA-512, Salted SHA-256, Salted SHA-1, Salted MD5 algorithms: Specifies the base64-encoded password salt used to generate the hash. For BCRYPT: Specifies the radix64-encoded password salt used to generate the hash.                                                                                                                                                                                                                                                                                                      | Only for Salted SHA-512, Salted SHA-256, Salted SHA-1, Salted MD5 algorithms. | 22 (only for BCRYPT algorithm) | 22 (only for BCRYPT algorithm) |
