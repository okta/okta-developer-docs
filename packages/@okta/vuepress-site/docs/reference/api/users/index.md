...
| salt       | String   | Only required for salted algorithms. For BCRYPT, specifies the radix64-encoded password salt used to generate the hash, which must be 22 characters long. For other salted algorithms, specifies the base64-encoded password salt used to generate the hash. |
