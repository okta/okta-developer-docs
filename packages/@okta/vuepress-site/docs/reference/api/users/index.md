...
>**Note:** Password can be recovered when [Any enrolled MFA factor](https://help.okta.com/oie/en-us/Content/Topics/identity-engine/authenticators/configure-sspr.htm) is enabled. This is supported only with IDX Pipeline.
