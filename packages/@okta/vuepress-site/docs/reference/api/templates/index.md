...
The key portion is a two-letter country code that conforms to [ISO 639-1](https://www.loc.gov/standards/iso639-2/PHP/ENGLISH_list.php), and the value is the translated SMS Template.
