...
The key portion is a two-letter country code that conforms to [ISO 639-1](https://www.iso.org/iso-639-language-code), and the value is the translated SMS Template.
