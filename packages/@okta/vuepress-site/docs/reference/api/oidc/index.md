...
Additionally, we reserved the scopes `online_access`<ApiLifecycle access="ea" /> and `device_sso`<ApiLifecycle access="ea" /> as they have a particular meaning in the Online Access and Native SSO flows respectively.
