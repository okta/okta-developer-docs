...
| grant_type              | Can be one of the following: `authorization_code`, `password`, `client_credentials`, `refresh_token`, `urn:ietf:params:oauth:grant-type:device_code`, `urn:ietf:params:oauth:grant-type:token-exchange`, `urn:ietf:params:oauth:grant-type:saml2-bearer`, `urn:openid:params:grant-type:ciba` <ApiLifecycle access="ie" />, `urn:okta:params:oauth:grant-type:otp` <ApiLifecycle access="ie" /> <ApiLifecycle access="ea" />, `urn:okta:params:oauth:grant-type:oob` <ApiLifecycle access="ie" /> <ApiLifecycle access="ea" />, `http://auth0.com/oauth/grant-type/mfa-otp` <ApiLifecycle access="ie" /> <ApiLifecycle access="ea" />, or `http://auth0.com/oauth/grant-type/mfa-oob` <ApiLifecycle access="ie" /> <ApiLifecycle access="ea" />. Determines the mechanism Okta uses to authorize the creation of the tokens.                                                                                                                                              | String |
...
<!-- TODO add direct auth fields here? -->
