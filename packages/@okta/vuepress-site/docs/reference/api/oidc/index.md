...
Additionally, we reserved the scopes `online_access` `<ApiLifecycle access="ea" /> and `device_sso` as they have a particular meaning in the Online Access and Native SSO flows respectively.
