...
| acr_values <ApiLifecycle access="ea" /> | Use this parameter in authorization request to increase the level of end-user assurance. Okta has created predefined values that are described in the [Predefined acr values](/docs/guides/step-up-authentication/main/#predefined-parameter-values) section. | Query | String  | FALSE |
