...
| sessionToken                                   | Okta one-time session token. This allows an API-based user sign-in flow (rather than the Okta sign-in page). Session tokens can be obtained through the [Authentication API](/docs/reference/api/authn/).                                                                                                                                                                                                                                                                                                                                          | Query       | String    | FALSE      |
...
| enroll_amr_values <ApiLifecycle access="ea" /> | Valid values: `pwd`, `kba`, `email`, `sms`, `tel`, `duo`, `symantec`, `google_otp`, `okta_verify`, `pop`, `oath_otp`, `rsa`, `yubikey`, `otp` and `fed`. See [Parameter details](#parameter-details).                                                                                                                                                                                                                                                                                                                                              | Query       | String    | FALSE      |
