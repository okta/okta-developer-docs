...
| authorization endpoint                                            | URL of the custom authorization server's [authorization endpoint](#authorize).                                                                   | String  |
| device_authorization_endpoint                                     | URL of the custome authorization server's [device authorize endpoint](#device-authorize).                                                                                                                      | String   |
