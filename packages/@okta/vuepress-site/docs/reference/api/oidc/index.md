...
Returns OpenID Connect metadata about your authorization server. This information can be used by clients to programmatically configure their interactions with Okta. Custom scopes aren't returned unless they are [configured to be publicly discovereable](/docs/guides/customize-authz-server/create-scopes/).
