...
**Description:** This event is deprecated. The new event type name is [policy auth_evaluate enforce](#policy-auth_reevaluate-enforce). This event is triggered when a post auth session evaluation occurs.
