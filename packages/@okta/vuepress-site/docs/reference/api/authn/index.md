...
> **Note:** If you are using Classic Identity Engine, the `deviceToken` parameter isn't shared between the Classic Identity Engine Authentication API and Okta Identity Engine-specific APIs. See [Upgrade to Okta Identity Engine](https://developer.okta.com/docs/guides/oie-upgrade-overview/main/).
