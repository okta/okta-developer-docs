...
> **Note:** The WebAuthN Factor is available for those using the [Style the Widget](/docs/guides/custom-widget/main/#style-the-okta-hosted-sign-in-widget). If you are using a self-hosted, customized sign-in widget, you must first upgrade to widget version 3.4.0 and enable the [configuration option](https://github.com/okta/okta-signin-widget#configuration).
