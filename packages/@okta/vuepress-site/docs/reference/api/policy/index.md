...
| `required` <ApiLifecycle access="ea" />   | Boolean | This property indicates whether the knowledge or possession factor is required by the assurance. This field is `false` if the knowledge or possession constraint has values for`excludedAuthenticationMethods`.  || `OPTIONAL`|
