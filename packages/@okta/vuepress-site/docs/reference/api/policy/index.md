...
> **Note:** The MFA Policy API is a <ApiLifecycle access="beta" /> release and available for Okta Classic Engine only. For Okta Identity Engine, use the Authenticator enrollment policy APIs.
