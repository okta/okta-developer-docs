...
| sector_identifier_uri              | When `subject_type` is `pairwise`, this URL references a file with a single JSON array of `redirect_uri` values used to calculate Pseudonymous Identifiers.                                                                        | URL <ApiLifecycle access="ea" />                                                                                                                                                                                                                                                                                               | TRUE     | FALSE    | FALSE     |
| subject_type                       | Array of OAuth 2.0 subject type strings. Default value: `public`                                                                                                                                                                   | Array of `public`, `pairwise`  <ApiLifecycle access="ea" />                                                                                                                                                                                                                                                                    | TRUE     | FALSE    | FALSE     |
