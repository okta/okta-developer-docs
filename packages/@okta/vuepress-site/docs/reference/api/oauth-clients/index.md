...
| grant_types                             | Array of OAuth 2.0 grant type strings. Default value: `authorization_code`                    | Array of `authorization_code`, `implicit`, `interaction_code`, `password`, `refresh_token`, `client_credentials`   | TRUE       | FALSE    | FALSE     |
