...
<ApiOperation method="get" url="/api/v1/authorizationServers/${authorizationServerId}/claims" />
...
| grantTypes   | Array of grantTypes that this condition includes. Accepted grantTypes: `authorization_code`, `password`, `refresh_token`, `client_credentials`, `urn:okta:params:oauth:grant-type:otp` <ApiLifecycle access="ie" /> <ApiLifecycle access="ea" />, `urn:okta:params:oauth:grant-type:oob` <ApiLifecycle access="ie" /> <ApiLifecycle access="ea" />, `http://auth0.com/oauth/grant-type/mfa-otp` <ApiLifecycle access="ie" /> <ApiLifecycle access="ea" /> or `http://auth0.com/oauth/grant-type/mfa-oob` <ApiLifecycle access="ie" /> <ApiLifecycle access="ea" />. Determines the mechanism Okta uses to authorize the creation of the tokens.           | `include` list                  | True                          |
