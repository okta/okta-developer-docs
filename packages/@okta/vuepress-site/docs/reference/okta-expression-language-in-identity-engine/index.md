...
](https://help.okta.com/oie/en-us/Content/Topics/identity-engine/devices/edr-integration-main.htm) and [Available EDR signals by vendor](https://help.okta.com/en/oie/okta_help_CSH.htm#ext-edr-integration-available-signals) for details about `vendor` and `signal`.
