...
In some cases, APIs have only been documented on the new beta reference site, and not on the old API reference that you're currently looking at. This page provides a list of those, so that you can easily find them.
