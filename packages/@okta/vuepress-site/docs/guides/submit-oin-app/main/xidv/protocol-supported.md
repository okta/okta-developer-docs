...
> **Notes:**
    > * Identity Verification (IDV) integration is an *Early Access* feature. To enable this feature in the Okta Admin Console, go to **Settings** > **Features** and turn on **Identity verification with vendor-submitted integrations**. [Manage Early Access and Beta features](https://help.okta.com/okta_help.htm?id=ext_Manage_Early_Access_features)
