...
1. In the **OIN catalog properties** section, specify the following OIN catalog information:
    ...
    | **Use Cases** | Add optional use case categories that apply to your integration:<br><ul><li>Automation</li> <li>Centralized Logging</li> <li>Directory HR and Sync</li> <li>Identity Verification</li> <li>Identity Governance and Administration (IGA)</li> <li>Multifactor Authentication</li> <li>Zero Trust</li></ul>Default use cases are assigned to your integration based on supported features. See [Use case guidelines](/docs/guides/submit-app-prereq/main/#use-case-guidelines). |
