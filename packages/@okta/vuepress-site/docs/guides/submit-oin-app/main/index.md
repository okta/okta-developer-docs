...
1. From the **This integration is read-only** information box, click **Edit integration**.
    > **Note:** Submissions in DRAFT status aren't in read-only mode, so you won't see the **This integration is read-only** information box. Continue to edit your draft submission in the OIN Wizard. See [Start a submission](#start-a-submission).
