...
1. From the **Test integration** page, click **Generate instance**.
    ...
    > **Note:** There's a limit of five app instances in the Integrator Free Plan org. The **Generate instance** option is deactivated when you reach this limit. Deactivate unused instances to make room for new instances in your org. See [Deactivate app instances in your org](#deactivate-an-app-instance-in-your-org).
...
> **Note:** There's a maximum of five active instances allowed in an Integrator Free Plan org, so [deactivate](#deactivate-an-app-instance-in-your-org) or delete any instances you aren't using. Click **Clear filter** to find instances in your org that may be active and ineligible for testing.
...
Since the Integrator Free Plan org has a limit of five active app instances, deactivate any instances you're not using in the org.
