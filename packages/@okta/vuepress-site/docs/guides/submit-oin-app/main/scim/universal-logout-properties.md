...
> **Notes:**
> * This section appears if you select Universal Logout with GTR.
> * Universal Logout integrations are only supported with SSO. If you want to submit a Universal Logout integration with SCIM provisioning, you must also submit an SSO integration with either SAML 2.0 or OIDC. For more information on Universal Logout with GTR, see [Universal Logout](https://developer.okta.com/docs/guides/oin-universal-logout-overview).
