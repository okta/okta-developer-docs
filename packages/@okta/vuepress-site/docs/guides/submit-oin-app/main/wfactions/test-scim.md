...
Use the [Okta Provisioning Test Plan](/standards/SCIM/SCIMFiles/okta-actions_test_plan_provisioning.xlsx) for guidance. The test plan provides test cases for full provisioning support. Skip the test cases for the features that your integration doesn't support.
