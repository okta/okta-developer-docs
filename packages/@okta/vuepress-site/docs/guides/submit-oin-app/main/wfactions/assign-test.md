...
1. Click **Done**.
   ...
   > **Note:** If your integration supports Entitlement Management, assign entitlements to the users manually for testing or automatically through a policy. For more information, see [Assign entitlements to users](https://help.okta.com/okta_help.htm?type=oie&id=assign_entitlements_to_users).
