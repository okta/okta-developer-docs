...
> **Note:** The process for specifying the variable app instance names in an OIDC app is explained in the [Submit an SSO integration: OIDC settings](/docs/guides/submit-sso-app-oidc/openidconnect/main/#oidc-settings).
