...
To start, you're going to need an org. An org is a private data space&mdash;provided by Okta&mdash;that holds all the resources you create to handle user authentication. See [Okta organizations](/docs/concepts/okta-organizations).
