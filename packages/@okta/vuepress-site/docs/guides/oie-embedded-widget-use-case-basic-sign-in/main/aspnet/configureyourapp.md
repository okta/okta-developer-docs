The Sign-In Widget uses the [Interaction Code flow](/docs/concepts/interaction-code/) to interact with Okta Identity Engine. Ensure Interaction Code flow is enabled:
