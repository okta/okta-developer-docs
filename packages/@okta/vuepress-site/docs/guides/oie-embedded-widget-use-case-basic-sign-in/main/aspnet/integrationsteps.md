...
After you complete the steps in [Use Case 1: Load the Widget](/docs/guides/oie-embedded-widget-use-case-load/-/main/) and the widget loads successfully, then the next step is for the user to sign in.  There is no additional code that needs to be added to your app for this step. The user enters their credentials, and clicks the **Next** or **Sign In** button.
