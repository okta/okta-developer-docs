...
* [Audit your Classic API dependencies](/docs/guides/oie-upgrade-audit-classic-api-dependencies/): Find Classic Engine patterns that remain in your apps after the upgrade and map them to a supported path
