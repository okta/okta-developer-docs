...
After the user signs in successfully, request basic user information from the authorization server using the tokens that were returned in the [authentication response](#handle-a-success-status).
