...
> **Note:** The [API Access Management](https://help.okta.com/en/prod/okta_help_CSH.htm#ext_API_Access) feature must be enabled in your Okta org for you to use a [Custom Authorization Server](/docs/concepts/auth-servers/#custom-authorization-server).
