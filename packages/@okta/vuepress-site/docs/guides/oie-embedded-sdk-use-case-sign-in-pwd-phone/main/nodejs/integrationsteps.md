...
### Ste1: Build a sign-in page on the client and authenticate the user credentials
...
### Step: Select the phone factor from the authenticator list
...
### Step: Build the phone verification method entry page
