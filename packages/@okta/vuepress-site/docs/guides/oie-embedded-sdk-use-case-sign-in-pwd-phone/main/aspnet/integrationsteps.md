...
### Step: Show the phone factor in the authenticator list
...
### Step: Select the phone factor by calling the SelectChallengeAuthenticatorAsync method
...
### Step: Build the phone number entry page
...
### Step: Call the EnrollAuthenticatorAsync method to submit the phone number and send the SMS
...
### Step: Handle the response from the EnrollAuthenticatorAsync method
...
### Step: Build or reuse the phone verification code page
...
### Step: Call the VerifyAuthenticatorAsync method to verify the phone code
...
### Step: Handle the response from the VerifyAuthenticatorAsync method (factor verifications completed)
