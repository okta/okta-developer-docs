...
- [The OpenID Connect Application Wizard](https://help.okta.com/okta_help.htm?id=ext_Apps_App_Integration_Wizard-oidc)
- [How to assign a user to an application](https://help.okta.com/okta_help.htm?id=ext-assign-apps)
