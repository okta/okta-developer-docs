...
* After the upgrade, [audit your Classic API dependencies](/docs/guides/oie-upgrade-audit-classic-api-dependencies/) to find any Classic Engine patterns that remain and plan their replacement.
