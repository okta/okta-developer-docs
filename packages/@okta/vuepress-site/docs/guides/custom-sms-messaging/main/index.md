...
Okta supports two variables for [SMS message templates](/docs/references/api/templates/):
...
> **Note:** Alternatively, you can use the [Okta Templates API](/docs/references/api/templates/) to manage custom SMS message templates.
