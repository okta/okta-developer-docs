...
over the app key to specify the certificate you previously associated with your integration.
...
In the sample response shown below, there are two certificates to check to find the previous certificate.
