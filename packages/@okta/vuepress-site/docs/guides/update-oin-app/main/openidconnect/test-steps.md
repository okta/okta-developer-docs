1. Generate an app instance from your updated integration configuration. See [Generate an instance for OIDC](/docs/guides/submit-oin-app/openidconnect/main/#generate-an-instance-for).
