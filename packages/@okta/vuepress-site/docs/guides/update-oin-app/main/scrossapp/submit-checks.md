...
The OIN Wizard checks whether all required test logs, matching your selected roles and protocols, are uploaded and passed for Cross App Access submissions.