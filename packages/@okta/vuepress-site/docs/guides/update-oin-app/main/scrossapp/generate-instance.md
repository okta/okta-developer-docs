1. Create an instance for your updated SSO integration, using the guide for your protocol:
   * [Generate an instance for SAML](/docs/guides/submit-oin-app/saml2/main/#generate-an-instance-for)
   * [Generate an instance for OIDC](/docs/guides/submit-oin-app/openidconnect/main/#generate-an-instance-for)
