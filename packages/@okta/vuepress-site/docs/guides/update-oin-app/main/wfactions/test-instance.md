Test the following on both your published and updated generated instances:

* For SSO integration updates, test the required flows in the [OIN Submission Tester](/guides/submit-oin-app/wfactions/main/#oin-submission-tester) with your generated test instance. Fix any test failures from the OIN Submission Tester, then regenerate the test instance (if necessary) and retest.
...
> **Note:** You need to perform all the testing flows on the published version of your integration for backwards compatibility.
