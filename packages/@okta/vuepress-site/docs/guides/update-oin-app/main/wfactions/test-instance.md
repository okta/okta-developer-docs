...
* For SSO integration updates, test the required flows in the [OIN Submission Tester](/docs/guides/submit-oin-app/wfactions/main/#oin-submission-tester) with your generated test instance. Fix any test failures from the OIN Submission Tester, then regenerate the test instance (if necessary) and retest.
