1. If you haven't already done so, set up your Okta org by completing the steps located at [Set up your Okta org for a password factor only use case](/docs/guides/oie-embedded-common-org-setup/aspnet/main/#set-up-your-okta-org-for-a-password-factor-only-use-case).
...
* If the Widget doesn't load and the following error is displayed: "There was an unexpected internal error. Please try again." Ensure that CORS is enabled. See [Add a trusted origin and enable CORS](/docs/guides/oie-embedded-common-org-setup/aspnet/main/#add-a-trusted-origin-and-enable-cors).
