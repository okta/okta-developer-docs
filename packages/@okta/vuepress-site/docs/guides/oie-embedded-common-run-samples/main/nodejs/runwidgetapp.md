...
After you have successfully run the sample app, the next step is to build your integration by using the sample app as your guide. See [Load the Widget](/docs/guides/oie-embedded-widget-use-case-load/nodejs/main/) to start using the Widget and explore the available use cases.
