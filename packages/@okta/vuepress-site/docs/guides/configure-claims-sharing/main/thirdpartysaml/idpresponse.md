> **Note:** The response is truncated for brevity.
...
Okta also supports comma separated values in addition to multi-value attribute values.

```JSON
.....
    <saml2:Attribute Name="session.amr" NameFormat="urn:oasis:names:tc:SAML:2.0:attrname-format:unspecified">
        <saml2:AttributeValue xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:type="xs:string">swk,pwd,sms</saml2:AttributeValue>
    </saml2:Attribute>
.....
```
