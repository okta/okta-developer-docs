...
* [Audit your Classic API dependencies](/docs/guides/oie-upgrade-audit-classic-api-dependencies/main/): Inventory your Classic Engine API usage and map each dependency to a supported path
