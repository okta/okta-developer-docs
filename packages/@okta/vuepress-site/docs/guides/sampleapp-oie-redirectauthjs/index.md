---
title: Redirect authentication with the Java Servlet sample app and Identity Engine
excerpt: Learn how to test some of the features of the Identity Dngine with the Java Servlet sample app
layout: Guides
---
