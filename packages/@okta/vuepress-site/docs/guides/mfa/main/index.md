...
* [Postman configured](/reference/rest/) to make API requests to your Developer Edition org
...
> **Note:** If you don't already have Postman set up, follow these instructions to [set up Postman](/reference/rest/) to work with Okta. There is also a dedicated page with all of our [Postman collections](/docs/reference/postman-collections/).
