...
> Note: You must first customize the Okta URL domain if you also want to customize the hosted [sign-in page](/docs/guides/custom-hosted-signin/) or [error pages](https://help.okta.com/en/prod/Content/Topics/Settings/custom-error-pages.htm/).
