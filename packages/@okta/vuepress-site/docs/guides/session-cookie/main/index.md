...
> **Important**: By default, Okta Classic orgs ignore the `sessionToken` in a request if there is already a session cookie set in the browser. It is possible to flip this behavior in a specific org by setting an internal flag; talk to your Okta rep to find out more.
