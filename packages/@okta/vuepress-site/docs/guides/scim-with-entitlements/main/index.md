...
excerpt: Create a SCIM 2.0 server that supports entitlements in Okta.
meta:
  - name: description
...
* Learn the elements that are required to build a SCIM 2.0 server that supports provisioning entitlements to an app integration in Okta
...
> **Note**: `isvname` is used as a placeholder in this schema. To ensure uniqueness of your URNs and locations, replace it with the name of your organization or similar. 
