...
At the top level, Your Okta organization contains a brand, which contains a default theme. The default brand is applied to your organization's subdomain/[custom domain](/docs/guides/custom-url-and-email-domain/) if you have specified one.
