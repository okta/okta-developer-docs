...
| `okta.pushProviders.manage`| Allows the app to create and manage push notification providers such as APNs and FCM | [Push Providers API](/docs/references/api/push-providers/)|
| `okta.pushProviders.read`| Allows the app to read push notification providers such as APNs and FCM | [Push Providers API](/docs/references/api/push-providers/)|
