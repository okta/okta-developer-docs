...
1. Optionally, click the **Application rate limits** tab to adjust the percentage rate limit capacity for this application. By default, each new application has this percentage set at 50%.
