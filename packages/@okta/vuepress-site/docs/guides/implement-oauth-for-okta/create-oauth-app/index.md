...
1. Click the **Assignments** tab and ensure that the right users are assigned to the app. For instructions on how to assign the application to individual users and groups, see the [Assign applications for people and groups](https://help.okta.com/en/prod/Content/Topics/Apps/Apps_Apps_Page.htm) topic in the Okta product documentation. For more information about which users have access to which scopes, see the <GuideLink link="../scopes">Scopes and supported endpoints</GuideLink> section.
