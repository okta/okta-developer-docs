...
By using this feature along with customizing the [domain](/docs/guidescustom-url-domain/) and error pages, you can use Okta-hosted flows and keep a seamless user experience with your application.
...
## Before You Begin
Before you can get started customizing your hosted sign-in page, you must have already customized your [Okta URL domain](/docs/guidescustom-url-domain/).
