...
1. On the **New Single-Page App Integration** page:
   ...
   * Set **Sign-in redirect URIs** to a URI that is appropriate for your app. For example, `http://localhost:4200/login/callback` if you're using the sample app.
   * Set **Sign-out redirect URIs** to a URI that is appropriate for your app. For example, `http://localhost:4200` if you're using the sample app.
...
1. Under **EMAIL VERIFICATION EXPERIENCE** set **Callback URI** to a URI that is appropriate for your app. For example, `http://localhost:4200/login/callback` if you're using the sample app.
1. Click **Save**.
