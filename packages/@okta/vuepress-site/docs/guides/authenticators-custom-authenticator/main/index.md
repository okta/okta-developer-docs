...
4. Verify that your notification services setup is valid. See [Edit a notification service](https://help.okta.com/okta_help.htm?type=oie&id=ext-all-notification-services).
5. Verify that your Click **Save** to allow push providers to attempt to send notifications again.
