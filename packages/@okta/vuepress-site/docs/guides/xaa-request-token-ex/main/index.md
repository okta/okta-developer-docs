...
* An Okta org that's used for SSO, such as an [Okta Integrator Free Plan org](https://developer.okta.com/signup). Register your requesting app with SSO and XAA capabilities in your Okta org. <StackSnippet snippet="see-need" inline />
