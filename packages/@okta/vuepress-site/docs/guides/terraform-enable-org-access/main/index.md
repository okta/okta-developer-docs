...
Okta _API scopes_ define permissions for an external API client like Terraform. For a full reference, see [the Okta list of Auth 2.0 API scopes](https://developer.okta.com/docs/api/oauth2/).
