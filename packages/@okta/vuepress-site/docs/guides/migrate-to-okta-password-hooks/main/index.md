...
A migration program uses Okta's [password import inline hook](/docs/references/password-hook/) feature to seamlessly migrate users as they authenticate. The broad strokes look like:
