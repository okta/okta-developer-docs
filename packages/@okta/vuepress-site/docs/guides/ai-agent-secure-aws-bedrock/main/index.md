...
* The AI Agent registered in your org. See [Configure AWS Identity and Access Management for AI agent imports](https://help.okta.com/oie/en-us/content/topics/ai-agents/ai-agent-configure-aws.htm).
