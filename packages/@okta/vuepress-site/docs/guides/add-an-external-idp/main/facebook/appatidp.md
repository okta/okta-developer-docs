1. Go to [<StackSelector snippet="idp" noSelector inline /> for Developers](https://developers.facebook.com) and register for a developer account if you haven't already done so.
