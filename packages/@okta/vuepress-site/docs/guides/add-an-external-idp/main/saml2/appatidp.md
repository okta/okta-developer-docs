...
* **IdP Issuer URI**: The issuer URI of the Identity Provider. This value is usually the <StackSelector snippet="idp" noSelector inline /> Metadata `entityID` of the Identity Provider `EntityDescriptor`.
