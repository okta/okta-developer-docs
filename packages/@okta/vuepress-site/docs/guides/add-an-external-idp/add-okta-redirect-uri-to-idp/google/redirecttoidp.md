1. On your Google APIs & Services dashboard, click **Credentials**, and then select the OAuth client app that you created in the <GuideLink link="../create-an-app-at-idp">first section</GuideLink>.
