...
application's code. This feature is important for mobile devices due to the challenges in updating applications. The
[sample application](/docs/guides/oie-embedded-common-run-samples/ios/main/),
provided in the Swift SDK's Git repository, uses the SDK to implement this dynamic policy
