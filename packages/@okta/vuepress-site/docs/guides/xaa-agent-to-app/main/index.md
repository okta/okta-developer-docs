...
1. Follow this guide to create an AI agent object in Okta and bound to an agent app: [Add AI agents manually](https://help.okta.com/okta_help.htm?type=oie&id=ai-agent-add-manually). For this configuration, select your custom agentic app (in step 1) in the **Delegations** tab of the AI agent page.
