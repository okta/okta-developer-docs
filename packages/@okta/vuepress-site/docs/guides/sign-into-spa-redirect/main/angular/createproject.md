...
Create an Angular app named **okta-angular-sample** using the following command. When the CLI prompts you for a style sheet format, choose whichever one you prefer&mdash;it doesn't affect the Okta integration.

```shell
npx @angular/cli@22 new okta-angular-sample --ssr=false
```

This creates the app using Angular 22, no matter which CLI version you installed.

> **Note**: This guide uses Angular CLI v22, okta-angular v8.0.0, and Okta Auth JavaScript SDK v8.0.1.
