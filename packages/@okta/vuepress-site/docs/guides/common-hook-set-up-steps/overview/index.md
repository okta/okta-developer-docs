...
A secure web server and application is a requirement to implement an Okta Event Hook or Inline Hook, and is referred to as the external service in these guides.
