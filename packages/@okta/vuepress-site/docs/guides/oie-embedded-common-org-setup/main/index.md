...
The guide is for web and server apps. To add sign-in to your mobile app, see [Overview of the mobile Identity Engine SDK](https://developer.okta.com/docs/guides/mobile-idx-sdk-overview/main/).
