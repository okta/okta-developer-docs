...
1. In the **Origin URL** field, specify the base URL of the website that you want to allow cross-origin requests from. If you are using the sample app, specify `https://localhost:44314/`.
