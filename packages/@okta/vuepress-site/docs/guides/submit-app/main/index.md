...
The Okta OIN team requires a dedicated account in your app to run their tests. Ensure that this test account is active during the submission review period for Okta to test and troubleshoot your integration. Okta recommends that you delete or deactivate the test account in your app within 30 days after your integration is published in the OIN. See [Test account guidelines](/docs/guides/submit-app-prereq/main/#test-account-guidelines).
