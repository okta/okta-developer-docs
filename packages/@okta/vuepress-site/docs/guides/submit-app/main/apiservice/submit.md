...
Generate a service app instance in your associated Okta Integrator Free Plan organization for testing. The app instance that you generate provides credentials for your API calls:
