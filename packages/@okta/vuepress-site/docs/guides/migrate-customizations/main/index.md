...
> **Important**: You can create brands programmatically, but themes are automatically generated when you create a brand. Import existing themes before you manage them with automation tools. This guide demonstrates the proper import workflow.
...
**Important:** Themes are automatically created when a brand is created. Import existing themes before you manage them.
...
After the content is defined in the script or configuration file, follow these steps:
