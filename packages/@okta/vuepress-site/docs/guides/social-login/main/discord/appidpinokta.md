...
* **Scopes**: Leave the defaults for a simple sign-in flow. You can also add scopes. See [OAuth2 Scopes](https://discord.com/developers/docs/topics/oauth2#shared-resources-oauth2-scopes).
