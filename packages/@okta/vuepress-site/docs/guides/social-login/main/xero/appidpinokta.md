...
* **Scopes**: Leave the defaults for a simple sign-in flow. You can also add more scopes. See [Organization scopes](https://developer.xero.com/documentation/guides/oauth2/scopes).
