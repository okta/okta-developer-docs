...
* **Scopes**: Leave the defaults for a simple sign-in flow. You can also add scopes. See [Scope attributes](https://developer.paypal.com/docs/log-in-with-paypal/integrate/reference/).
