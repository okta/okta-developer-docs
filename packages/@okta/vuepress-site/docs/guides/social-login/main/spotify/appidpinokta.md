...
* **Scopes**: Leave the defaults for a simple sign-in flow. You can also add scopes. See [Authorization Scopes](https://developer.spotify.com/documentation/general/guides/authorization/scopes/).
