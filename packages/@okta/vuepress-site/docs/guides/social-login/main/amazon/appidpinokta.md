...
* **Scopes**: Leave the defaults for a simple sign-in flow. You can also add more scopes. See [Customer Profile](https://developer.amazon.com/docs/login-with-amazon/customer-profile.html).
