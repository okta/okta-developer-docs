...
* An Okta org (such as an [Okta Integrator Free Plan organization](https://developer.okta.com/signup))
...
1. Sign in to your Okta Integrator Free Plan organization as a user with administrative privileges.
