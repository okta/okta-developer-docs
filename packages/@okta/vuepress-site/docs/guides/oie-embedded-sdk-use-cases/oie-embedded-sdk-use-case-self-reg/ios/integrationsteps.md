...
and `completion` closure. This closure is invoked once when the sign-up completes
...
See [Get user profile information after sign in](/docs/guides/oie-embedded-sdk-use-cases/ios/oie-embedded-sdk-use-case-basic-sign-in/#get-user-profile-information-after-sign-in).
