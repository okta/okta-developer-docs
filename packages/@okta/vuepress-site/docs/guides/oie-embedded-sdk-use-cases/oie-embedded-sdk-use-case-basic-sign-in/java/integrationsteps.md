...
### Step 3: Handle response from Okta and the SDK
...
> **Note:** You can obtain basic user information after the user is authenticated by making a request to Okta's Open ID Connect authorization server. See [Get user profile information after sign in](#get-user-profile-information-after-sign-in) for details.
