1. From the command line inside the `samples-nodejs-express-4` directory, start the <StackSnippet snippet="applang" noSelector inline /> app by running `npm run okta-hosted-login-server`.
