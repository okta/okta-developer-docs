...
2. Go to **Applications and Resources** > **Applications**, and then click **Create App Integration** > **Classic experience**.
...
3. In the Add an Identity Provider dialog box, define the following:
    ...
    * **Scopes**: Leave the defaults.
    ...
    > **Note:** For more information about these settings and the **Advanced Settings**, see [Identity Provider Settings](/docs/guides/add-an-external-idp/openidconnect/main/#create-an-identity-provider-in-okta).
