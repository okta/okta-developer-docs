...
5. Return to your sample application and sign in with an Okta user who is NOT in the Patients data store.
    ...
    - If you extended the sample application, click on `Profile` in the left-hand navigation pane. Only the the user info claims are included in the table.
...
6. Sign out of the sample application, and now sign in with an Okta user who IS in the Patients data store.
    ...
    - If you extended the sample application, click on `Profile` in the left-hand navigation pane. The patient ID is added as part of the Claims table.
