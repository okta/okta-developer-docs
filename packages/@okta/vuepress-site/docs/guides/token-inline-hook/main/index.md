...
This guide provides a useable example of an Okta token inline hook. It uses the website [Glitch.com](https://glitch.com) to act as an external service to receive and respond to token inline hook calls.
...
* Implement a simple useable example of a token inline hook with a Glitch.com external service.
