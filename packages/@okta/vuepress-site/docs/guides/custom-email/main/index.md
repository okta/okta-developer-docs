...
1. In the Admin Console, go to **Customizations** > **Branding**. (If you enabled multibrand customization, got to **Customizations** > **Brands**, and then select the brand you want.)
