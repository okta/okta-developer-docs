...
| Registration - Activation (Self-service Registration) | Activate Account | `SelfServiceRegistrationActivation` | Sent to users who can follow the provided link or use an OTP to complete their self-registration |
