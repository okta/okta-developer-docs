...
In this MFA scenario, there’s an additional email factor to verify, therefore the `authenticate()` call returns an `AuthenticationResponse` object with a list of one other factor to verify: the email factor.
