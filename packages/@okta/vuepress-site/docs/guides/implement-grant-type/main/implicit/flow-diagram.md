...
4. Okta redirects the browser back to the specified redirect URI, along with access and ID tokens as a hash fragment in the URI.<br>
The redirect URI is specified when your app was registered in Okta.
