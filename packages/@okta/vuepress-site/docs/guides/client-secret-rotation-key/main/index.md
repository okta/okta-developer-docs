...
* Access to the new APIs: Client Secret Management `/api/v1/apps/{yourAppClientId}/credentials/secrets` and JWKS Management `/api/v1/apps/{yourAppClientId}/credentials/jwks`
