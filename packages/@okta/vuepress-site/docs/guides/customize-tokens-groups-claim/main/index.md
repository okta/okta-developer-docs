...
* Create a Groups claim to ID tokens for App Groups and User Groups
* Add a Groups claimWhy it's good practice to create a service account for use with an API token
