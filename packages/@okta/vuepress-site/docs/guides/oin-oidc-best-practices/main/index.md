...
The logo file must be smaller than 1 MB and be in either PNG, JPG, or GIF file format. For best results, use a 200 x 200 pixels square-dimension PNG image with a transparent background. For more logo guidelines, see [Logo guidelines in OIN submission requirements](/docs/guides/submit-app-prereq/main/#logo-guidelines).
