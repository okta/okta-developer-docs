...
* Make sure that in your app configuration, the `redirect_uri` is an absolute URI and that it is allowlisted by specifying it in [Trusted Origins](/docs/reference/api/trusted-origins/).
