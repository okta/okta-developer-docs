...
* Have the Device Authorization Grant feature enabled for your org. From the left navigation pane in the Admin Console, go to **Settings** > **Features**, locate the evice Authorization Grant slider, and slide to enable.
