### User access
  ...
  ![Flow diagram illustrating the process of the initial authentication flow for user access](/img/auth/ai-agent-token-exchange/user-access-authentication-step-secret-1192893v2.svg)
...
### Machine access
  ...
  ![Flow diagram illustrating the process of the initial authentication flow for machine access](/img/auth/ai-agent-token-exchange/machine-access-authentication-step-secret-1192893v2.svg)
...
<div class="full wireframe-border">
  ...
  ![Flow diagram illustrating the process of AI agent token exchange](/img/auth/ai-agent-token-exchange/token_exchange_flow_for_secret-1192893v2.svg)
