<div class="full wireframe-border">
  ...
  ![Flow diagram illustrating the process of AI agent token exchange](/img/auth/ai-agent-token-exchange-secret.png)
...
AIAgent -> OAS: 3 Token exchange (requesting Secret)
OAS ..> AIAgent: Returns Secret credentials
AIAgent -> RS: 4 Resource request with Secret credentials
