...
* [Use a custom domain](/docs/guides/custom-url-and-email-domain/): Customize your Okta organization by replacing your Okta domain name (for example, dev-12345.okta.com) with your own domain name (for example, id.example.com) so that all URLs look like your application.
...
* [Email domain setup](/docs/guides/custom-url-and-email-domain/main/#about-configuring-a-custom-email-domain): Update the "From" address and domain of the emails sent to your users.
...
> **Note:** Configuring CORS isn't needed if you are using Okta's [custom domain feature](/docs/guides/custom-url-and-email-domain/main/#enable-the-custom-domain).
