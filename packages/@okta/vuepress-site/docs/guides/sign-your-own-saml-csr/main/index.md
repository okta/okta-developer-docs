...
See [Get Started with the Okta REST APIs](/reference/rest/) for information on how to use the Postman REST API test client for these steps.
...
* [Get Started with the Okta REST APIs](/reference/rest/)
