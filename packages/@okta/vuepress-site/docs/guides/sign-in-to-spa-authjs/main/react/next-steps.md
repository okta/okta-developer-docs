After you create a basic sign-in flow React app with a custom sign-in experience using the SDK, you can extend your app's sign-in experience. You can add features such as multifactor or social IdP authentication.
