After you create a basic sign-in flow for the Vue.js app, you can extend your app's sign-in experience. You can add features such as multifactor, self-registration, or social IdP authentication.
