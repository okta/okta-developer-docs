...
* If you modify your theming using the primary color in the Admin Console, Okta generates an accessible palette. However, the generated palette might not map exactly to your brand's palette. See [Set a theme for your org](https://help.okta.com/okta_help.htm?type=oie&id=ext-branding-set-theme).
