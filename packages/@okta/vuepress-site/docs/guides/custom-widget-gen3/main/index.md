...
The third generation of the Sign-In Widget offers autogenerated palettes that preserve accessible color contrast ratios. If you decide to override the autogenerated palettes, you assume the risk of breaking accessibility.

Consider the following when adjusting the color of your brand in your org:

* If you don't modify your brand colors, you can use the Okta default colors.
* If you change the primary color of your brand
