...
This guide explains how to customize the third-generation (Gen3) of the Sign-In Widget for redirect authentication.

> **Notes:**
>
> * See [Migrate to the third generation (Gen3) of the Sign-In Widget](/docs/guides/custom-widget-migration-gen3/main/) for details about a migration to Gen3.
> * See [Style the sign-in page](/docs/guides/custom-widget/main/) if you’re using Okta Classic Engine.
...
* Learn about palette generation and accessibility.
...
Gen3 of the Sign-In Widget offers the same user experience as Gen2. It adds accessibility improvements to the following:
...
Gen3 of the Sign-In Widget provides autogenerated palettes that preserve accessible color contrast ratios.
...
* If you modify your theme using the primary color in the Admin Console, Okta generates an accessible palette. However, the generated palette might not map exactly to your brand's palette. See [Understand Sign-In Widget color customization](https://help.okta.com/okta_help.htm?type=oie&id=SIW-color-contrast).
