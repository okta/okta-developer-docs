...
| **Verify a factor:**<br>`/api/v1/authn/factors/{id}/verify` only                                             | 100              | 300              | 300*    | 600*       | - (Shares the same bucket as /api/v1/authn)                |
...
| **Get System Log data:**<br>`/api/v1/events`                                                                 | 20               | 25               | 25      | 50         | - (Shares the same bucket as /api/v1)               |
