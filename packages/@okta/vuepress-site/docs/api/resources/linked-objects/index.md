...
The Expression Language function for [linked objects](/docs/reference/okta_expression_language/#linked-object-function) provides access to the details about a linked user.
