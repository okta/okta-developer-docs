      ...
      footer_nav: {
        ...
        more: {
          ...
          items: [
            ...
            { text: 'Integrate with Okta', link: 'https://developer.okta.com/integrate-with-okta/' },
            { text: 'Change Log', link: 'https://developer.okta.com/docs/release-notes/' },
            { text: '3rd-party notes', link: 'https://developer.okta.com/3rd_party_notices/' },
          ]
        },
        websites: {
          items: [
