...
[Build a Single Sign-On Integration](/docs/guides/build-sso-integration/saml2/main/). As you follow the instructions to [Create your integration](/docs/guides/build-sso-integration/saml2/main/#create-your-integration), there are two steps where you will do things differently:
...
1.  Open the the `saml-autoconfig.php` file for SimpleSAMLphp in your favorite text editor.
    ...
    "[Setting up a SAML application in Okta](/docs/guides/build-sso-integration/saml2/main/#create-your-integration)"
