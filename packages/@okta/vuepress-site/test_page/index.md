...
* <ApiLifecycle access="beta" /> Nec turpis semper amet metus ridiculus porta, dolor eu diam:
    * `prompt`, Primis ad cum fusce Nunco [`/oauth2/${authorizationServerId}/v1/authorize`](https://developer.okta.com/docs/api/openapi/okta-oauth/oauth/tag/OrgAS/)(custom authorization server)
    * `consent_method`, magnis nisi euismod penatibus posuere
    * `consent`, integer taciti [scopes](https://developer.okta.com/docs/api/openapi/okta-management/management/tag/AuthorizationServerScopes/)
